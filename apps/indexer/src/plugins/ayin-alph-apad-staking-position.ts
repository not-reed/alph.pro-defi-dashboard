...
const STAKING_CONTRACT = "yZYGnp1ZyamEeFKapcjX2WJujMN53bDjP5UtpDVE7M2w";
const REWARD_TOKEN = "vT49PY8ksoUL6NcXiZ1t2wAmC7tTPRfFfER8n3UCLvXy"; // ayin
const DEPOSIT_TOKEN = "vFpZ1DF93x1xGHoXM8rsDBFjpcoSsCi5ZEuA5NG5UJGX"; // alph-apad

export class AyinAlphApadPositionPlugin extends Plugin<PluginData> {
	PLUGIN_NAME = "ayin-alph-apad-staking-position";

	startDate = new Date(1718906966851);
