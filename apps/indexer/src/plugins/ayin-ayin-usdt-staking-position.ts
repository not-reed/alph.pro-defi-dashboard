...
const STAKING_CONTRACT = "26xEgX7N63GCDTZejFhSTsNuUTetbaGtV1mxsyLNBHmyZ";
const REWARD_TOKEN = "vT49PY8ksoUL6NcXiZ1t2wAmC7tTPRfFfER8n3UCLvXy"; // ayin
const DEPOSIT_TOKEN = "21NEBCk8nj5JBKpS7eN8kX6xGJoLHNqTS3WBFnZ7q8L9m"; // ayin-usdt

export class AyinAyinUsdtPositionPlugin extends Plugin<PluginData> {
	PLUGIN_NAME = "ayin-ayin-usdt-staking-position";
