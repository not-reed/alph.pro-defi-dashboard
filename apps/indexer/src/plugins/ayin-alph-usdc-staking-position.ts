...
const STAKING_CONTRACT = "242tGBfUiKUfVQQE9NL7afobFzfFRaLXSYkoQv84a5Ph9";
const REWARD_TOKEN = "vT49PY8ksoUL6NcXiZ1t2wAmC7tTPRfFfER8n3UCLvXy"; // ayin
const DEPOSIT_TOKEN = "283R192Z8n6PhXSpSciyvCsLEiiEVFkSE6MbRBA4KSaAj"; // alph-usdc

export class AyinAlphUsdcPositionPlugin extends Plugin<PluginData> {
	PLUGIN_NAME = "ayin-alph-usdc-staking-position";

	startDate = new Date(1718362781558);
