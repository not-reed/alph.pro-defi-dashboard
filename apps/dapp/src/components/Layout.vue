...
import { CurrencyDollarIcon, HomeIcon, HomeModernIcon, PhotoIcon } from '@heroicons/vue/24/outline';
...
<template>
    <div class="flex mb-10 md:mb-0">
        ...
        <div class="flex-1 min-h-full flex flex-col">
            ...
            <div class="md:dark:border-calypso-800 flex-1 md:border-l">
                <slot />
            </div>
        </div>

    </div>
    <div class="fixed -bottom-1 bg-calypso-700 left-0 right-0 md:hidden h-8 border-t border-calypso-900">
        <ul class="flex justify-around text-calypso-800">
            <li>
                <RouterLink to="/">
                    <div class="bg-calypso-700 rounded-full p-2 relative -top-2 border-t border-calypso-900">
